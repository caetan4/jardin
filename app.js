...
const geometr = new THREE.SphereGeometry(1,18,18);
const geomet = new THREE.SphereGeometry(1,18,18);
const CylinderGeometryr= new THREE.CylinderGeometry( 5, 5, 20, 32 ); 
const CylinderMaterial= new THREE.MeshBasicMaterial( {color: "#5a341aff"} ); 
const cylinder = new THREE.Mesh( CylinderGeometryr, CylinderMaterial); scene.add( cylinder );
//const geomet = new THREE.SphereGeometry(1,18,18);
const material = new THREE.MeshPhongMaterial({
  flatShading: true, specular : "#ffffffff", shininess: 100, color: "rgba(118, 141, 15, 1)"});
